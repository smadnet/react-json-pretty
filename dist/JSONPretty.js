...
var JSONPretty = /** @class */ (function (_super) {
    ...
    JSONPretty.prototype.render = function () {
            ...
            try {
                ...
                return (React.createElement("div", __assign({}, rest, {
                    dangerouslySetInnerHTML: {
                        __html: tagName === "pre" ? "<pre class=\"__json-pretty-error__\"" + getStyle('error', theme, styles) + ">" + xss(obj) + "</pre>" : "<div class=\"__json-pretty-error__\"" + getStyle('error', theme, styles) + ">" + xss(obj) + "</div>"
                    }
                })));
            }
        }
        return (React.createElement("div", __assign({}, rest, {
            dangerouslySetInnerHTML: {
                __html: tagName === "pre" ? "<pre class=\"" + themeClassName + "\"" + getStyle('main', theme, styles) + ">" + this._pretty(theme, obj, replacer, +space, styles) + "</pre>" : "<div class=\"" + themeClassName + "\"" + getStyle('main', theme, styles) + ">" + this._pretty(theme, obj, replacer, +space, styles) + "</div>"
            }
        })));
    };
    // JSON =》 HTML转换器
